    ...
    <div className="mb-6 p-4 border border-gray-300 rounded-lg bg-white shadow-md space-y-6">
      ...
      <div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <label
            htmlFor="imageUpload"
            className="px-3 py-2 text-sm rounded shadow bg-indigo-500 text-white hover:bg-indigo-600 transition-colors cursor-pointer"
          >
            Télécharger Planche
          </label>
          <input
          ...
          <label
            ...
            className="px-3 py-2 text-sm rounded shadow bg-purple-500 text-white hover:bg-purple-600 transition-colors cursor-pointer"
          >
            Ouvrir Projet
          </label>
          <input
          ...
          <ToolButton
            ...
            disabled={!isProjectLoaded || isSaving}
            title={!isProjectLoaded ? "Chargez une image d'abord" : "Sauvegarder le projet (.json)"}
          >
            Sauvegarder Projet
          </ToolButton>
          <ToolButton
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
          ...
          <div className="flex items-center gap-4">
            <div>
              <label
                htmlFor="textColor"
                className="font-medium mb-1 text-sm text-gray-600 block"
              >
                Texte
              </label>
              <input
        ...
        {BUBBLE_TYPES_WITH_BORDERS.includes(settings.activeBubbleType) && (
          <div className="mb-4">
            <h3 className="font-medium mb-1 text-sm text-gray-600">
              Épaisseur bordure : {effectiveBorderWidth}px
            </h3>
            <div className="flex items-center gap-3">
              <input
                ...
                onChange={(e) => {
                  ...
                  onSettingChange({ activeBorderWidth: v });
                }}
                className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
        ...
        {(settings.activeBubbleType === BubbleType.SpeechDown ||
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {settings.activeBubbleType === BubbleType.Thought && (
              <div className="p-2 border rounded border-gray-200 bg-gray-50">
                <h4 className="font-medium text-xs text-gray-500 mb-1">
                  Points Pensée (Nouvelles Bulles)
                </h4>
                <div className="flex items-center gap-2 text-sm">
