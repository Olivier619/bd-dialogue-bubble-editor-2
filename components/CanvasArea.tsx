...
export const CanvasArea = forwardRef<HTMLDivElement, CanvasAreaProps>(
  (
    ...
    const handleClick = (e: React.MouseEvent<HTMLDivElement>) => {
      ...
      // Check if click is on a bubble or its parts
      const target = e.target as HTMLElement;
      if (target.closest('.bubble-item-component')) {
        // Selection is handled by BubbleItems mousedown
        return;
      }
    ...
    return (
      <div ref={ref}>
        {/* Parent ref for html2canvas */}
        <div id="actual-canvas-content" target-for-html2canvas>
